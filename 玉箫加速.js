(function () {
    ...
    var _cssText = [
        ...
        '@keyframes xiaoImgBreath{0%,100%{filter:url(#chromaKey) drop-shadow(0 0 8px rgba(74,156,204,.35))}50%{filter:url(#chromaKey) drop-shadow(0 0 22px rgba(74,204,240,.85))}}',
        '#xiao-trigger.scrolled{opacity:.35;transform:translateY(-50%) scale(.92)}',
        '#xiao-trigger .xiao-img{width:100%;height:100%;display:block;object-fit:cover;border-radius:8px;background:transparent !important;pointer-events:none;filter:url(#chromaKey) drop-shadow(0 0 10px rgba(74,156,204,0.5))}',
        ...
        /* === 移动端数学优化 ===
         * 国产安卓典型: 360×720/800, 393×873, 412×915
         * Wp = clamp(260px, 85vw, 340px) 面板宽
         * Hp = clamp(360px, 65vh, 520px) 面板高
         * Hb = clamp(28px, 8vw, 34px)   按钮高
         * Wt = clamp(60px, 22vw, 80px)  触发球宽
         * Ht = clamp(150px, 55vw, 200px) 触发球高
         * F-title = clamp(16px, 5vw, 20px)
         * F-num   = clamp(22px, 7.5vw, 30px)
         * F-btn   = clamp(10px, 3vw, 12px) */
        '@media(max-width:640px){#xiao-trigger{width:clamp(60px,22vw,80px);height:clamp(150px,55vw,200px);left:10px}#xiao-trigger .xiao-speed-tag{font-size:9px;padding:2px 6px}.sound-waves{width:clamp(40px,14vw,50px);height:clamp(20px,7vw,24px)}#xiao-panel{width:clamp(260px,85vw,340px);max-width:none;left:-110%}#xiao-panel.open{left:8px}.panel-body{padding:0 10px 10px;max-height:clamp(360px,65vh,520px);overflow-y:auto}.panel-header{padding:10px 0 6px;margin-bottom:6px}.panel-title{font-size:clamp(16px,5vw,20px);letter-spacing:4px}.panel-subtitle{font-size:9px}.panel-seal{width:24px;height:24px;font-size:8px}.panel-xiao-wrap{gap:10px}.panel-xiao{width:clamp(48px,14vw,60px);height:clamp(96px,28vw,120px)}.wave-vis{height:clamp(80px,22vw,100px)}.speed-display{padding:6px 8px;margin-bottom:8px}.speed-num{font-size:clamp(22px,7.5vw,30px)}.speed-mood{font-size:clamp(9px,2.8vw,11px)}.hole-btn{width:20px;height:20px}.hole-btn.active::after{width:6px;height:6px}.hole-label{font-size:9px}.hole-selector{gap:6px;padding:6px;margin-bottom:8px}.speed-btn{height:clamp(28px,8vw,34px);font-size:clamp(10px,3vw,12px)}.speed-grid{gap:5px;margin-bottom:8px}.scene-btn{padding:clamp(4px,1.2vw,6px) clamp(6px,2vw,10px);font-size:clamp(9px,2.6vw,11px)}.ctrl-btn{padding:clamp(6px,1.8vw,8px) 0;font-size:clamp(10px,3vw,12px)}.panel-close{width:24px;height:24px;font-size:13px}.speed-slider{height:4px}.speed-slider::-webkit-slider-thumb{width:16px;height:16px}.speed-slider::-moz-range-thumb{width:16px;height:16px}.kb-hint{display:none}}',
        /* 小屏 ≤380px (Redmi 13C 360×720等低端机) */
        '@media(max-width:380px){.panel-body{padding:0 8px 8px}.panel-header{padding:8px 0 4px;margin-bottom:4px}.panel-title{font-size:15px;letter-spacing:3px}.panel-xiao-wrap{gap:8px}.speed-display{padding:4px 6px;margin-bottom:6px}.speed-num{font-size:22px}.hole-selector{padding:4px;gap:4px}.ctrl-btn{padding:5px 0;font-size:10px}.speed-btn{height:26px;font-size:9px}.scene-btn{padding:3px 5px;font-size:8px}}',
        /* 横屏 ≤500px高度 */
        '@media(max-height:500px){#xiao-trigger{width:clamp(40px,12vh,56px);height:clamp(100px,30vh,140px)}#xiao-trigger .xiao-speed-tag{font-size:8px;padding:1px 4px;bottom:-16px}.sound-waves{width:36px;height:18px}#xiao-panel{max-height:calc(100vh - 8px)}.panel-body{max-height:calc(100vh - 8px)}#xiao-panel.open{left:calc(clamp(40px,12vh,56px) + 12px)}}',
    ...
    _trigger.innerHTML = [
        ...
        '<video class="xiao-img" src="xiao02.webm" autoplay loop muted playsinline preload="auto"></video>',
